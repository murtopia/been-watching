-- FINAL Setup for Nick - Works with Existing Profile
-- This finds your existing profile and adds watch data to it
...
BEGIN
    ...
    RAISE NOTICE '   Using user_id: %', nick_user_id;

    -- Step 1: Update profile with username
    ...
    -- Step 3: Temporarily disable triggers
    ...
    -- Step 2: Insert watch statuses (using user_id directly)
    ...
    RAISE NOTICE '';
    RAISE NOTICE '🎉 ============================================';
    RAISE NOTICE '✅ Nick''s watch data setup complete!';
    RAISE NOTICE '============================================';
    RAISE NOTICE '';
