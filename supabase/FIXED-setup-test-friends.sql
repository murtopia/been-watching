-- ============================================
-- FIXED: Test Friends Setup for Been Watching
-- ============================================
-- This version works with Supabase's default profiles table structure
...
BEGIN
    ...
    -- Note: Setting both id and user_id to the same value for test accounts
    INSERT INTO public.profiles (id, user_id, username, display_name, bio, avatar_url, created_at)
    VALUES
        (taylor_id, taylor_id, 'Taylor.Murto', 'Taylor Murto', 'What have you been watching?', NULL, NOW()),
        (todd_id, todd_id, 'Toddles', 'Todd Williams', 'What have you been watching?', NULL, NOW()),
        (pat_id, pat_id, 'Mossy', 'Pat Moss', 'What have you been watching?', NULL, NOW())
