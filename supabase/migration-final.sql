...
-- Drop the existing watch_status type if it exists
DROP TYPE IF EXISTS public.watch_status CASCADE;
...
-- Create watch_status table (now safe since we dropped the type)
