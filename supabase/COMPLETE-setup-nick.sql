-- COMPLETE Setup for Nick's Account
-- This creates the profile if it doesn't exist, then adds all watch data

DO $$
DECLARE
    nick_id UUID := 'ac15f0ac-ef46-4efc-bee3-96084ede16ad';
BEGIN
    RAISE NOTICE '🎬 Setting up Nick''s account...';

    -- Step 1: Create or update Nick's profile
    INSERT INTO public.profiles (id, user_id, username, display_name, bio)
    VALUES (nick_id, nick_id, 'Murtopia', 'Nick Murto', 'What have you been watching?')
    ...
    INSERT INTO public.watch_status (user_id, media_id, status) VALUES
        -- Currently Watching
        (nick_id, 'tv-194764', 'watching'),
        (nick_id, 'tv-136311', 'watching'),
        (nick_id, 'tv-214120', 'watching'),
        (nick_id, 'tv-125988', 'watching'),
        (nick_id, 'tv-110492', 'watching'),
        (nick_id, 'tv-95480', 'watching'),
        (nick_id, 'tv-249039', 'watching'),
        -- Watched
        (nick_id, 'tv-216082', 'watched'),
        (nick_id, 'tv-157741', 'watched'),
        (nick_id, 'tv-113962', 'watched'),
        (nick_id, 'movie-1005331', 'watched'),
        (nick_id, 'tv-225385', 'watched'),
        (nick_id, 'tv-222766', 'watched'),
        (nick_id, 'tv-130853', 'watched'),
        (nick_id, 'tv-147050', 'watched'),
        (nick_id, 'movie-533535', 'watched'),
        (nick_id, 'tv-108978', 'watched'),
        (nick_id, 'tv-247718', 'watched'),
        (nick_id, 'tv-250923', 'watched'),
        (nick_id, 'movie-748783', 'watched'),
        -- Want to Watch
        (nick_id, 'tv-60622', 'want'),
        (nick_id, 'movie-1064028', 'want'),
        (nick_id, 'tv-111800', 'want')
    ...
    RAISE NOTICE '';
    RAISE NOTICE '🎉 ============================================';
    RAISE NOTICE '✅ Nick''s account setup complete!';
    RAISE NOTICE '============================================';
    RAISE NOTICE '';
