-- Nick's Watch Data - V2 (Fixed Trigger Issue)
-- This script uses specific trigger names, not ALL triggers
...
BEGIN
    ...
    -- Step 2: Temporarily disable only custom triggers (not system triggers)
